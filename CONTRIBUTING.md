# Xsimarket Contribution Guide

**BUGS:**

To encourage active collaboration, Xsimarket encourages pull requests, not just bug reports. "Bug reports" may also be sent in the form of a pull request containing a negative test.
...
Major new features should always be sent to the master branch, which contains the upcoming Xsimarket release.

**Code style:**

Xsimarket follows PSR-2 for coding standards and PSR-4 as of Laravel for autoloading standards.

**PHPDoc:**

Below is an example of a valid Xsimarket doc block. Note that the @param attribute is followed by two spaces, the argument type, two more spaces, and finally, the variable name:
  ``` php
    /**
