...
use Newsletter;
use Carbon\Carbon;
use Xsimarket\Traits\WalletsTrait;
use Illuminate\Support\Str;
use Illuminate\Http\Request;
use Xsimarket\Enums\Permission;
use Illuminate\Http\Response;
use Xsimarket\Mail\ContactAdmin;
use Xsimarket\Database\Models\User;
use Illuminate\Support\Facades\DB;
use Xsimarket\Database\Models\Wallet;
use Illuminate\Support\Facades\Log;
use Xsimarket\Database\Models\Profile;
use Xsimarket\Otp\Gateways\OtpGateway;
...
use Xsimarket\Http\Requests\UserUpdateRequest;
use Illuminate\Validation\ValidationException;
use Xsimarket\Http\Requests\ChangePasswordRequest;
use Xsimarket\Database\Repositories\UserRepository;
use Xsimarket\Database\Repositories\DownloadRepository;
use Spatie\MediaLibrary\MediaCollections\Models\Media;
use Xsimarket\Database\Models\Permission as ModelsPermission;
...
class UserController extends CoreController
{
    ...
    public function socialLogin(Request $request)
    {
        ...
        try {
            ...
            throw new XsimarketException(INVALID_CREDENTIALS);
        }
    }
    ...
    protected function validateProvider($provider)
    {
        if (!in_array($provider, ['facebook', 'google'])) {
            throw new XsimarketException(PLEASE_LOGIN_USING_FACEBOOK_OR_GOOGLE);
        }
    }
    ...
    protected function getOtpGateway()
    {
        ...
        $gateWayClass = "Xsimarket\\Otp\\Gateways\\" . ucfirst($gateway) . 'Gateway';
    ...
    public function sendOtpCode(Request $request)
    {
        ...
        try {
            ...
            throw new XsimarketException(INVALID_GATEWAY);
        }
    }
    ...
    public function verifyOtpCode(Request $request)
    {
        try {
            ...
            throw new XsimarketException(OTP_VERIFICATION_FAILED);
        } catch (\Throwable $e) {
            throw new XsimarketException(OTP_VERIFICATION_FAILED);
        }
    }
    ...
    public function makeOrRevokeAdmin(Request $request)
    {
        ...
        if ($this->repository->hasPermission($user)) {
            ...
            try {
                ...
                throw new XsimarketException(USER_NOT_FOUND);
            }
