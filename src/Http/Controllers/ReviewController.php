...
use Xsimarket\Database\Repositories\ReviewRepository;
use Xsimarket\Exceptions\XsimarketException;
use Xsimarket\Http\Requests\FeedbackCreateRequest;
use Xsimarket\Http\Requests\ReviewCreateRequest;
use Xsimarket\Http\Requests\ReviewUpdateRequest;
...
class ReviewController extends CoreController
{
    ...
    public function store(ReviewCreateRequest $request)
    {
        ...
        try {
            ...
            if (count($review)) {
                throw new XsimarketException(ALREADY_GIVEN_REVIEW_FOR_THIS_PRODUCT);
            }
