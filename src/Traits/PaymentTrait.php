...
use Xsimarket\Database\Models\PaymentGateway;
...
use Xsimarket\Database\Models\PaymentIntent;
...
trait PaymentTrait
{
    ...
    {
        // brand & network are equivalent with razorpay & stripe, "network" in Xsimarket DB
        // type & funding are equivalent with razorpay & stripe, "type" in Xsimarket DB
