...
use Xsimarket\Database\Models\Availability;
use Xsimarket\Database\Models\Product;
use Xsimarket\Database\Models\Resource;
...
class ProductRepository extends BaseRepository
{
    ...
    {
        return  Availability::where('bookable_id', $variation_id)->where('bookable_type', 'Xsimarket\Database\Models\Variation')->whereDate('from', '>=', $from)->whereDate('to', '<=', $to)->get();
    }
