...
use Xsimarket\Traits\Excludable;
...
class Product extends Model
{
    ...
    {
        return  Availability::where('product_id', $this->id)->where('bookable_type', 'Xsimarket\Database\Models\Product')->whereDate('to', '>=', Carbon::now())->get();
    }
