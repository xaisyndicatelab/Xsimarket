...
use Xsimarket\Payments\PaymentInterface;
use Xsimarket\Payments\Base;
use Xsimarket\Traits\OrderStatusManagerWithPaymentTrait;
use Xsimarket\Enums\OrderStatus;
use Xsimarket\Enums\PaymentStatus;
use Xsimarket\Traits\PaymentTrait;
...
class Stripe extends Base implements PaymentInterface
{
  ...
  public function getIntent($data): array
  {
    try {
      ...
      throw new XsimarketException(INVALID_CARD);
    } catch (\Stripe\Exception\RateLimitException $e) {
      throw new XsimarketException(TOO_MANY_REQUEST);
    } catch (\Stripe\Exception\InvalidRequestException $e) {
      throw new XsimarketException(INVALID_REQUEST);
    } catch (\Stripe\Exception\InvalidArgumentException $e) {
      throw new XsimarketException(INVALID_REQUEST);
    } catch (\Stripe\Exception\AuthenticationException $e) {
      throw new XsimarketException(AUTHENTICATION_FAILED);
    } catch (\Stripe\Exception\ApiConnectionException $e) {
      throw new XsimarketException(API_CONNECTION_FAILED);
